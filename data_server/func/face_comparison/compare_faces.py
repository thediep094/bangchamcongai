...
from func.face_comparison.face_detection import get_face
...
def run(image_one, image_two, save_dest=None):
    ...
    # norm_diff = torch.tensor(embedding_one).unsqueeze(0) - torch.tensor(embedding_two).unsqueeze(0)
